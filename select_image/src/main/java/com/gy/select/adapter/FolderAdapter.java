                ...
                if (mFolders.size() > 0) {
                    ...
                    if (f != null) {
                        Glide.with(mContext)
                                ...
                                .apply(new RequestOptions().centerCrop().error(R.mipmap.mis_default_error))
                                .into(holder.cover);
//                        holder.cover.setImageBitmap(BitmapUtils.decodeSampledBitmapFromFile(f.cover.path));
                    } else {
        ...
        void bindData(Folder data) {
            ...
            if (data.cover != null) {
                ...
                Glide.with(mContext)
                        ...
                        .apply(new RequestOptions().centerCrop().placeholder(R.mipmap.mis_default_error))
                        .into(cover);
//                cover.setImageBitmap(BitmapUtils.decodeSampledBitmapFromFile(data.cover.path));
            } else {
