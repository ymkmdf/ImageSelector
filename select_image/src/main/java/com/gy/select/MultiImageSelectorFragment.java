...
import com.gy.select.adapter.FolderAdapter;
import com.gy.select.adapter.ImageGridAdapter;
import com.gy.select.bean.Folder;
import com.gy.select.bean.Image;
import com.gy.select.utils.FileUtils;
import com.gy.select.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public String FILE_CONTENT_FILEPROVIDER = "";
...
//    private CheckPermission mCheckPermission;
    ...
    public void onAttach(Context context) {
        FILE_CONTENT_FILEPROVIDER = context.getPackageName()+".fileprovider";
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        Uri uri = FileProvider.getUriForFile(getActivity(), FILE_CONTENT_FILEPROVIDER, mTmpFile);
